...
@Component({
  selector: 'app-air-twoway-ticket-outbound',
  templateUrl: './air-twoway-ticket-outbound.page.html',
  styleUrls: ['./air-twoway-ticket-outbound.page.scss'],
})
export class AirTwowayTicketOutboundPage implements OnInit {
  public tickets = [
