...
@Component({
  selector: 'app-air-twoway-ticket-inbound',
  templateUrl: './air-twoway-ticket-inbound.page.html',
  styleUrls: ['./air-twoway-ticket-inbound.page.scss'],
})
export class AirTwowayTicketInboundPage implements OnInit {
  public tickets = [
